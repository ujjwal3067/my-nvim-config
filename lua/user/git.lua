...
-- plugin link : https://github.com/lewis6991/gitsigns.nvim
...
-- NOTE : This is deafult config and is placed is just for reference purpose
gitsigns.setup({
  signs = {
  ...
  max_file_length = 40000, -- Disable if file is longer than this (in lines) ( performance optimization)
  preview_config = {
